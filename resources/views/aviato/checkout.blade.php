...
<form method="Post" action="{{route('prueva.update',$pru->id)}}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="nombre" required value="{{$pru->nombreu}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="sexo">Producto</label>
        <input type="text" class="form-control" name="sexo" required value="{{$pru->nombre}}">
    </div>
    <div class="form-group">
        <label for="edad">Precio</label>
        <input type="text" class="form-control" name="edad" required value="{{$pru->precio}}">
    </div>
    <div class="form-group">
